...
- (void)viewWillAppear:(BOOL)animated {
    self.username.text = [NSString stringWithFormat:@"%@%@", kUserPrefix, self.notification.fromUserName];
    self.roomName.text = [NSString stringWithFormat:@"%@%@", kRoomPrefix, self.notification.roomName];
