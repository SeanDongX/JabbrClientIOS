 ...
 * represents a single user message.
 *  The message can be a text message or media message, depending on how it is
 * initialized.
 *  It implements the `JSQMessageData` protocol and it contains the senderId,
 * senderDisplayName,
 *  and the date that the message was sent. If initialized as a media message it
...
/**
 *  Returns the string identifier that uniquely identifies the user who sent the
 * message.
 */
@property(copy, nonatomic, readonly) NSString *senderId;

/**
 *  Returns the display name for the user who sent the message. This value does
...
/**
 *  Returns a boolean value specifying whether or not the message contains
 * media.
...
/**
 *  Returns the body text of the message, or `nil` if the message is a media
 * message.
 *  That is, if `isMediaMessage` is equal to `YES` then this value will be
 * `nil`.
 */
@property(copy, nonatomic, readonly) NSString *text;

/**
 *  Returns the media item attachment of the message, or `nil` if the message is
 * not a media message.
